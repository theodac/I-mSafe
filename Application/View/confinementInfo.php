...
<form>
    ...
    <div class="row">
        ...
        <div class="small-6 large-8 columns text-center"><h3>Adresse de votre abri </h3></div>
        <div class="small-3 large-2 columns">...</div>
    ...
    <div class="row">
        <div class="small-3 large-2 columns">...</div>
        <div class="small-6 large-8 columns text-center"><h3>Nombre de personne </h3></div>
        <div class="small-3 large-2 columns">...</div>
